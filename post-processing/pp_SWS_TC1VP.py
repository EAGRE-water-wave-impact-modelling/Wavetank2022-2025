...
if scheme=='MMP':
	data_path1='TC_MMP/data/MMP/TC1_dt' # simulation using dt
	data_path2='TC_MMP/data/MMP/TC1_dt_half' # simulation using dt/2
	figure_name ='TC0_MMP.png'
else: # scheme=='SV'
	data_path1='TC_SV/data/SV/TC1_dt'
	data_path2='TC_SV/data/SV/TC1_dt_half'
